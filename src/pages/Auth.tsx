    ...
    try {
      if (isLogin) {
        ...
        toast({
          ...
          description: "Welcome to ReelForge AI. Let's create something amazing!",
        });
        navigate("/dashboard");
      }
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 -left-1/4 w-[500px] h-[500px] rounded-full bg-primary/15 blur-[100px]" />
        <div className="absolute bottom-1/4 -right-1/4 w-[400px] h-[400px] rounded-full bg-accent/15 blur-[80px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          {/* Auth Card */}
          <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-lifted">
            {/* Tabs */}
